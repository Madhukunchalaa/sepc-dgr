        ...
        sections: [
            ...
            },
            {
                ...
                rows: [
                    ...
                    { sn: "2.2", particulars: "Partial Loading", uom: "%", daily: power?.partial_loading_pct, mtd: await getMTDAvg(plantId, targetDate, 'partial_loading_pct'), ytd: await getYTDAvg(plantId, targetDate, 'partial_loading_pct') },
